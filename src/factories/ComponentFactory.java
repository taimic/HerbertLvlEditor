...
public class ComponentFactory {
	...
	public static final String COMPONENT_PACKAGE = "components.";
	...
	public static Component createDefault(Class<?> componentType){
	...
	// Creates an empty component of the given type
	public static Component createDefault(String componentType){
	...
	private static boolean instantiateComponent(){
		...
		try {
			currentComponent = (Component) componentClass.getConstructor().newInstance();
			return true;
