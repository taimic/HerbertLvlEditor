...
public class SceneFactory {
	...
	public static final String COMPONENT_PACKAGE = "scenes.";
	...
	private static Scene currentComponent;
	...
	public static Scene createDefault(Class<?> componentType){
	...
	// Creates an empty component of the given type
	public static Scene createDefault(String componentType){
	...
	private static boolean instantiateComponent(){
		...
		try {
			currentComponent = (Scene) componentClass.getConstructor().newInstance();
			return true;
			...
			System.out.println("Constructor not found for class: " + componentClass + ". Is it private?");
